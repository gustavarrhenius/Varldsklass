    ...
    public class EFDBInitializer : DropCreateDatabaseAlways<EFDbContext>
    {
        protected override void Seed(EFDbContext context)
        {
            ...
            var posts = new List<Post>
            {
                ...
                new Post { ID = 9, Title = @"Om Oss", Body = @"<p>På de flesta av våra utbildningar så finns möjligheten att gå med på en <span>Öppen utbildning</span> om det inte finns någon datum som passar så skicka in en förfråga om kommande utbildningstillfällen, eller om ni vill ha en egen utbildning som är skräddarsydd efter er verksamhet så fixar vi det!</p> 
            <p>Har du funderingar så hör gärna av dig till oss, dina åsikter är viktiga för oss!</p> <p>VÄRLDSKLASS.COM</p> <p>Telefon: 0320 - 109 39</p> <p>Bokning & offert  073 - 551 50 96</p> <p>E-post: info@varldsklass.com</p> <p>Öppettider</p> <p>Må-Fre: 08.00-17.00</p><p>Lö: Stängt</p><p>Sö: Stängt</p><p>Huvudkontor: Lövåsgatan 11, 511 54 KINNA</p> <p>Bankgiro: 5400-9907</p> <p>Företaget godkänt för F-skatt.</p>", Created = new DateTime(2012, 9, 25), postType = 1, Events = null },
